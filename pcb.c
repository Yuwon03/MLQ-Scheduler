...
PcbPtr createnullPcb(void)
{
    ...
    new_process_Ptr->args[0] = "./sigtrap";
    ...
    new_process_Ptr->initial_priority = 0;
    new_process_Ptr->priority = 0;
    new_process_Ptr->time_in_current_quantum = 0;
    new_process_Ptr->time_at_current_level = 0;
    new_process_Ptr->total_wait_time = 0;
    new_process_Ptr->start_time = -1;
    new_process_Ptr->completion_time = -1;
    new_process_Ptr->response_time = -1;
    new_process_Ptr->last_ready_queue_entry_time = 0;
    new_process_Ptr->last_enqueued_time = 0;
    new_process_Ptr->job_id = -1;
...
PcbPtr suspendPcb (PcbPtr p)
{
    ...
    {
        perror("ERROR: Failed to suspend process");
        return NULL;
    }
